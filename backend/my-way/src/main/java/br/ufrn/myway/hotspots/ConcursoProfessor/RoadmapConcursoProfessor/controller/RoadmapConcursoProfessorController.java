package br.ufrn.myway.hotspots.ConcursoProfessor.RoadmapConcursoProfessor.controller;
...
public class RoadmapConcursoProfessorController implements AbstractRoadmapController<
        RequestRoadmapDTO, RequestFullRoadmapDTO, ResponseRoadmapDTO> {

    @Autowired
    private RoadmapConcursoProfessorService roadmapService;
    ...
    public ResponseEntity<ResponseRoadmapDTO> create(
        ...
        return ResponseEntity.ok(
                roadmapMapper.toResponse(
                        roadmapService.save(
                                roadmapMapper.toRoadmapConcursoProfessor(roadmapDTO), userId
                        )
                )
        );
    }
