package br.ufrn.myway.hotspots.ConcursoPoliciaCivil.RoadmapConcursoPoliciaCivil.controller;
...
public class RoadmapConcursoPoliciaCivilController implements AbstractRoadmapController<
        RequestRoadmapDTO,
...
> {
    ...
    @Autowired
    private RoadmapConcursoPoliciaCivilService roadmapService;
    
    @Autowired
    private RoadmapMapper roadmapMapper;
    
    /**
      * Creates a new Policia Civil roadmap for the specified user.
      * @param roadmapDTO Data transfer object containing roadmap details.
      * @param userId Identifier of the user for whom the roadmap is created.
      * @return ResponseEntity containing the created roadmap details.
      */
    @Override
    @PostMapping("/{userId}")
    public ResponseEntity<ResponseRoadmapDTO> create(
            @RequestBody RequestRoadmapDTO roadmapDTO,
            @PathVariable Long userId
    ) {
        return ResponseEntity.ok(
                roadmapMapper.toResponse(
                        roadmapService.save(
                                roadmapMapper.toRoadmapConcursoPoliciaCivilEntity(roadmapDTO), userId
                        )
                )
        );
    }
    ...
    /**
     * Creates and saves a full Policia Civil roadmap for the specified user.
     * @param roadmapDTO Data transfer object containing full roadmap details.
     * @param userId Identifier of the user for whom the roadmap is saved.
     * @return ResponseEntity containing the saved roadmap details.
     */
    @Override
